...
public class Assets
{
  ...
  final static String modelGrass = Assets.modelPath + "/plain-floor.g3db";
  final static String modelStones = Assets.modelPath + "/plain-floor.g3db";
  final static String modelConcrete = Assets.modelPath + "/plain-floor.g3db";
}
